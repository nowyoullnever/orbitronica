...
var PhaserNode = class _PhaserNode {
  ...
  async setState(v) {
    ...
    this.#state = { schemaVersion: 1, params: { rate: clamp2(raw.rate, 0.05, 10), depth: clamp2(raw.depth, 0, 1), stages: Math.round(clamp2(raw.stages, 4, 8)), feedback: clamp2(raw.feedback, -0.95, 0.95), mix: clamp2(raw.mix, 0, 1) } };
    this.apply(this.#state.params);
  }
  destroy() {
