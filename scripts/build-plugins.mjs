...
for (const id of firstPartyIds) {
  ...
  await build({ entryPoints: [path.join(source, "index.ts")], outfile: path.join(output, "index.js"), bundle: true, format: "esm", target: "es2022", legalComments: "none", preserveSymlinks: true });
