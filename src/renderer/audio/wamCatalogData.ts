...
export const WAM_CATALOG_DATA = [
  ...
  {
    id: "orbitronica-flanger",
    displayName: "Orbitronica Flanger",
    pluginVersion: "1.0.0",
    packageVersion: "0.1.0",
    license: "MIT",
    entry: "wam/orbitronica-flanger/index.js",
    descriptor: "wam/orbitronica-flanger/descriptor.json",
    hasGui: true,
  },
  {
    id: "orbitronica-phaser",
    displayName: "Orbitronica Phaser",
    pluginVersion: "1.0.0",
    packageVersion: "0.1.0",
    license: "MIT",
    entry: "wam/orbitronica-phaser/index.js",
    descriptor: "wam/orbitronica-phaser/descriptor.json",
    hasGui: true,
  },
  {
